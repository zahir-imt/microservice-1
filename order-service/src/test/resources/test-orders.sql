...
(1, 'order-123', 'user', 'Zh', 'abc@gmail.com', '11111111', '123 Main St', 'Apt 1', 'Dallas', 'TX', '75001', 'USA', 'NEW', null),
(2, 'order-456', 'user', 'Is', 'def@gmail.com', '2222222', '123 Main St', 'Apt 1', 'Toronto', 'ON', 'M1C 0A5', 'Canada', 'NEW', null)
;
